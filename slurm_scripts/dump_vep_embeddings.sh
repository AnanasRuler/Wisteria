...
# MOH_mamba_1_8_layer-8_seqlen-32k_norcp
seq_len=32768
bp_per_token=1
embed_dump_batch_size=1
model_name_or_path="DNAINSP/outputs/MOH_mamba_1_8-32768_d_model-256_n_layer-8_lr-8e-3_rcps-false/"
name="MOH_mamba_1_8_downstream-seqlen=32k"
rcps_flag="no-rcps"
#####################################################################################
